  ...
  return (
    <div className="mx-auto max-w-5xl px-6 py-16">
      ...
      <p className="mt-2 text-sm text-tiffany-800/70">
        サイトの「お問い合わせ」フォームから届いた内容の一覧です。返信は各メールアドレス宛に直接お願いします。
      </p>
          ...
          <table className="w-full text-left text-sm">
            ...
            <tbody>
              {inquiries.map((inquiry) => (
                <tr key={inquiry.id} className="border-t border-tiffany-50 align-top">
                  ...
                  <td className="px-4 py-3 text-tiffany-800/70">
                    <a href={`mailto:${inquiry.email}`} className="hover:text-tiffany-700">
                      {inquiry.email}
                    </a>
                  </td>
                  <td className="max-w-md whitespace-pre-line px-4 py-3 text-tiffany-800/70">
                    {inquiry.message}
                  </td>
